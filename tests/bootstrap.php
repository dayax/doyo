...
$wp_test_dir = realpath(__DIR__.'/../vendor/dayax/wordpress-test');
...
define( 'DIR_TESTDATA', $wp_test_dir.'/data' );
...
require_once( $wp_test_dir.'/includes/mock-mailer.php' );
$phpmailer = new MockPHPMailer(); 

system( WP_PHP_BINARY . ' ' . escapeshellarg( $wp_test_dir. '/includes/install.php' ) . ' ' . escapeshellarg( $config_file_path ) . ' ' . $multisite );
...
require $wp_test_dir.'/includes/testcase.php';
require $wp_test_dir.'/includes/testcase-xmlrpc.php';
require $wp_test_dir.'/includes/testcase-ajax.php';
require $wp_test_dir.'/includes/exceptions.php';
require $wp_test_dir.'/includes/utils.php';
